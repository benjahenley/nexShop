...
export function WatchImg(props: any): any {
  return <img className={props.className} src="/media/watch.jpg" alt="file" />;
}
...
export function TwitterImg(props: any): any {
  return <TwitterSVG className={props.className}></TwitterSVG>;
}
export function ProfileIcon(props: any): any {
  return <ProfileSVG className={props.className} onClick={props.onClick} />;
}

export function InstagramImg(props: any): any {
  return <InstagramSVG className={props.className}></InstagramSVG>;
}
